...
#===============================================================================
# IntelliPerf CI Test Suite - Quick Run (2 iterations)
...
# Setup results directory - store in project directory
results_dir=./intelliperf_test_results
rm -rf "$results_dir"
mkdir -p "$results_dir"
...
echo 'All traces saved to:' "$results_dir/*/trace/"
echo '======================================='
