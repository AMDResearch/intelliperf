...
def matmul_kernel(
    ...
    offs_am = (new_pid // num_pid_n * BLOCK_SIZE_M + tl.arange(0, BLOCK_SIZE_M))[:, None]
    offs_bn = (new_pid % num_pid_n * BLOCK_SIZE_N + tl.arange(0, BLOCK_SIZE_N))[None, :]
    ...
    offs_cm = new_pid // num_pid_n * BLOCK_SIZE_M + tl.arange(0, BLOCK_SIZE_M)
    offs_cn = new_pid % num_pid_n * BLOCK_SIZE_N + tl.arange(0, BLOCK_SIZE_N)
